...
import { useGetStudentExtraCourses } from "../../../api/admin/users";
...
export default function StudentExtraCourses() {
  ...
  const { data: courses = [], isLoading, error } = useGetStudentExtraCourses(id);
  ...
  if (error) {
    ...
    if (error.response?.status === 404) {
      return <div>No extra courses found for this student.</div>;
    }
